...
class TurnoIntegradorTest {
    ...
    public void registrarTurno() throws Exception {
        ...
        domicilio.setCalle("Madelena");
        domicilio.setNumero("78");
        domicilio.setLocalidad("Lumbrera");
        domicilio.setProvincia("Medellín");
        paciente.setNombre("Alfonso");
        paciente.setApellido("Castaño");
        paciente.setDni("89456147");
